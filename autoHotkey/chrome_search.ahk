...
{
    Run, C:\Program Files\Google\Chrome\Application\chrome.exe %clipb%
    return
}
...
Run, C:\Program Files\Google\Chrome\Application\chrome.exe %google%%clipb% ; open ms edge with parameter concatenation of the google string and clipb string
return
